	...
	private function _login(){
		...
		if($user){
			if($user['is_active'] == 1){
				...
				$this->session->set_flashdata('pesan','<div class="alert alert-warning alert-message" role="alert"><div class="alert-icon">
            		<i class="material-icons">warning</i>
          			</div>Akun belom di aktifasi</div>');
				redirect('login');
			}
		}else{
			$this->session->set_flashdata('pesan','<div class="alert alert-warning alert-message" role="alert"><div class="alert-icon">
            <i class="material-icons">warning</i>
          </div>Email tidak terdaftar !</div>');
				redirect('login');
		}
	}
