...
<body class="login-page sidebar-collapse">
 <!--  <div id="loading"></div> -->
   <div class="page-header header-filter" style="background-image: url('<?= base_url('assets/'); ?>img/bg08.jpg'); background-size: cover; background-position: top center;">
    <div class="container">
      <div class="row">
        <div class="col-md-6 ml-auto mr-auto">
          <div class="card card-login">
            <form class="form" method="post" action="<?= base_url('Daftar'); ?>">
              <div class="card-header card-header-primary text-center">
                <h4 class="card-title">Silahkan Lengkapi Formulir dibawah ini</h4>
              ...
              <div class="card-body">
                ...
                <div class="input-group">
                  ...
                  <?= form_error('nama','<small class="text-danger pl-3 error-message">','</small>'); ?>
                </div>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                ...
                <div class="input-group">
                  ...
                  <?= form_error('nohp','<small class="text-danger pl-3 error-message">','</small>'); ?>
                </div>
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                ...
                <div class="input-group">
                  ...
                  <select name="pilih" class="form-control selectpicker" data-style="btn btn-success">
                    <option value="Daftar sebagai">Daftar sebagai</option>
                    <option value="2">petani</option> 
                    <option value="3">Mitra/pekerja</option>
                  </select>
                  <?= form_error('password','<small class="text-danger pl-3 error-message">','</small>'); ?>
                </div>
              </div>
              <div class="text-center">
                <button type="submit" class="btn btn-primary btn-wd btn-lg">Daftar</button>
              </div>
              <div class="text-center">
                <a href="<?= base_url('login');?>">Sudah Punya Account !!</a>
              </div>
            </form>
          </div>
        </div>
...
<!--   <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script> -->
  ...
  <script>
    ...
    $('.error-message').alert().delay(3000).slideUp('slow');
